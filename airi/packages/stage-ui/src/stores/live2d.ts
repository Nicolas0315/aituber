...
export const useLive2d = defineStore('live2d', () => {
  ...
  const [emotionMotionMap, resetEmotionMotionMap] = createResettableLocalStorage<Record<string, { group: string, index?: number } | null>>('settings/live2d/emotion-motion-map', {})
